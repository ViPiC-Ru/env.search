...
// 1.4.0 ищет данне для переменных среды
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.checkStringArgs=function(h,a,n){if(null==h)throw new TypeError("The 'this' value for String.prototype."+n+" must not be null or undefined");if(a instanceof RegExp)throw new TypeError("First argument to String.prototype."+n+" must not be a regular expression");return h+""};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;
$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(h,a,n){if(h==Array.prototype||h==Object.prototype)return h;h[a]=n.value;return h};
$jscomp.getGlobal=function(h){h=["object"==typeof globalThis&&globalThis,h,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var a=0;a<h.length;++a){var n=h[a];if(n&&n.Math==Math)return n}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};
$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(h,a){var n=$jscomp.propertyToPolyfillSymbol[a];if(null==n)return h[a];n=h[n];return void 0!==n?n:h[a]};$jscomp.polyfill=function(h,a,n,d){a&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(h,a,n,d):$jscomp.polyfillUnisolated(h,a,n,d))};
$jscomp.polyfillUnisolated=function(h,a,n,d){n=$jscomp.global;h=h.split(".");for(d=0;d<h.length-1;d++){var k=h[d];if(!(k in n))return;n=n[k]}h=h[h.length-1];d=n[h];a=a(d);a!=d&&null!=a&&$jscomp.defineProperty(n,h,{configurable:!0,writable:!0,value:a})};
$jscomp.polyfillIsolated=function(h,a,n,d){var k=h.split(".");h=1===k.length;d=k[0];d=!h&&d in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var m=0;m<k.length-1;m++){var c=k[m];if(!(c in d))return;d=d[c]}k=k[k.length-1];n=$jscomp.IS_SYMBOL_NATIVE&&"es6"===n?d[k]:null;a=a(n);null!=a&&(h?$jscomp.defineProperty($jscomp.polyfills,k,{configurable:!0,writable:!0,value:a}):a!==n&&(void 0===$jscomp.propertyToPolyfillSymbol[k]&&(n=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[k]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(k):$jscomp.POLYFILL_PREFIX+n+"$"+k),$jscomp.defineProperty(d,$jscomp.propertyToPolyfillSymbol[k],{configurable:!0,writable:!0,value:a})))};$jscomp.polyfill("String.prototype.repeat",function(h){return h?h:function(a){var n=$jscomp.checkStringArgs(this,null,"repeat");if(0>a||1342177279<a)throw new RangeError("Invalid count value");a|=0;for(var d="";a;)if(a&1&&(d+=n),a>>>=1)n+=n;return d}},"es6","es3");
var search=new App({argWrap:'"',altWrap:"'",envWrap:"%",keyDelim:"=",csvDelim:";",tsvDelim:"\t",putDelim:"\\\\",envType:"Process"});
(function(h,a,n){a.lib.extend(a,{fun:{translit:function(d){var k="";var m={"щ":"shch","ё":"yo","ж":"zh","ч":"ch","ш":"sh","ю":"yu","я":"ya","х":"kh","а":"a","б":"b","в":"v","г":"g","д":"d","е":"e","з":"z","и":"i","й":"j","к":"k","л":"l","м":"m","н":"n","о":"o","п":"p","р":"r","с":"s","т":"t","у":"u","ф":"f","ц":"c","ы":"y","э":"e","ъ":"","ь":""};d=d||"";for(var c=0,t=d.length;c<t;c++){var p=!1;for(var u in m)if(value=d.substr(c,u.length),p=value.toLowerCase()==u)break;p?((p=value==value.toLowerCase())?
value=m[u]:(value=d.substr(c+u.length,1),value=(p=value==value.toUpperCase())?m[u].toUpperCase():m[u].substr(0,1).toUpperCase()+m[u].substr(1)),c+=u.length-1):value=d.substr(c,1);k+=value}return k},escape:function(d,k,m,c){m=m?""+m:"";var t=String.fromCharCode(27);switch(d){case "color":t+="[";var p="m";var u=t+"0"+p;switch(k){case "black":var r="90";break;case "red":r="91";break;case "green":r="92";break;case "yellow":r="93";break;case "blue":r="94";break;case "purple":r="95";break;case "cyan":r=
"96";break;case "white":r="97";break;case "default":r="0"}break;case "cursor":switch(t+="[",r="1",u=t+"2K",k){case "up":p="A";break;case "down":p="B";break;case "forward":p="C";break;case "backward":p="D"}}r&&p&&(m=t+r+p+m,c&&(m+=u));return m},checkDataProperty:function(d,k){return!!d&&(!k||a.lib.hasValue(d["USR-NAME"],k,!1)||a.lib.hasValue(d["USR-NAME"],a.fun.translit(k),!1)||a.lib.hasValue(d["NET-HOST"],k,!1)||a.lib.hasValue(d["DEV-NAME"],k,!1)||a.lib.hasValue(d["USR-LOGIN"],k,!1)||a.lib.hasValue(d["PCB-BIOS-SERIAL"],
k,!1)||a.lib.hasValue(d["DEV-DESCRIPTION"],k,!1)||a.lib.hasValue(d["NET-MAC"],k,!1)||a.lib.hasValue(d["SYS-KEY"],k,!1)||a.lib.hasValue(d["NET-IP-V4"],k,!1)||a.lib.hasValue(d["SYS-VERSION"],k,!1))},getItemProperty:function(d,k){var m="";try{m=d.get(k)}catch(c){}return m},getDataPattern:function(d,k,m){var c,t=0,p={},u=0;k=k?""+k:"";d=(d?""+d:"").split(a.val.envWrap);for(var r=0,B=d.length;r<B&&!u;r++){var w=d[r];if(r%2&&r!=B-1)if(c=m?w:w.toUpperCase()){w=d[r+1];var f=w.length?k.indexOf(w,t):k.length;
~f?(p[c]=k.substr(t,f-t),t=f):u=3}else u=2;else f=k.indexOf(w,t),t==f?t+=w.length:u=1}return u?{}:p},setDataPattern:function(d,k,m){k=k||{};d=(d?""+d:"").split(a.val.envWrap);for(var c=0,t=d.length;c<t;c++)if(c%2&&c!=t-1){var p=d[c];d[c]="";for(var u in k)a.lib.compare(u,p,!m)||(d[c]=k[u])}return d.join("")},clearPattern:function(d){d=(d?""+d:"").split(a.val.envWrap);for(var k=0,m=d.length;k<m;k++)if(!(k%2&&k!=m-1)){var c=d[k];d[k]=a.lib.strPad("",c.length," ","left")}return d.join(a.val.envWrap)}},
init:function(){var d,k,m=[],c={},t={},p={},u=!1,r=!1,B=!1,w=!0,f=0;var D=new ActiveXObject("WScript.Shell");var e=new ActiveXObject("Scripting.FileSystemObject");var E=new ActiveXObject("wbemScripting.Swbemlocator");E.security_.impersonationLevel=3;if(!f){var q=h.arguments.length;for(d=0;d<q;d++){var b=h.arguments.item(d);if(!("service"in c)){var g=a.lib.strim(b,null,a.val.keyDelim,!1,!1).toLowerCase();if("service"==g){b=a.lib.strim(b,a.val.keyDelim,null,!1,!1);var l=b.split(a.val.argWrap);3!=l.length||
l[0]||l[2]||(b=l[1]);c[g]=b;continue}}if(!("item"in c)&&(g=a.lib.strim(b,null,a.val.keyDelim,!1,!1).toLowerCase(),"item"==g)){b=a.lib.strim(b,a.val.keyDelim,null,!1,!1);l=b.split(a.val.argWrap);3!=l.length||l[0]||l[2]||(b=l[1]);c[g]=b;continue}if(!("unit"in c)&&(g=a.lib.strim(b,null,a.val.keyDelim,!1,!1).toLowerCase(),"unit"==g)){b=a.lib.strim(b,a.val.keyDelim,null,!1,!1);l=b.split(a.val.argWrap);3!=l.length||l[0]||l[2]||(b=l[1]);c[g]=b;continue}if(!("search"in c)&&(g=a.lib.strim(b,null,a.val.keyDelim,
!1,!1).toLowerCase(),"search"==g)){b=a.lib.strim(b,a.val.keyDelim,null,!1,!1);l=b.split(a.val.argWrap);3!=l.length||l[0]||l[2]||(b=l[1]);c[g]=b;B=!0;continue}if(!("index"in c)&&(g=a.lib.strim(b,null,a.val.keyDelim,!1,!1).toLowerCase(),"index"==g)){b=a.lib.strim(b,a.val.keyDelim,null,!1,!1);l=b.split(a.val.argWrap);3!=l.length||l[0]||l[2]||(b=l[1]);b=isNaN(b)?-1:Number(b)-1;c[g]=b;u=!0;continue}if(!("action"in c)&&(g=a.lib.strim(b,null,a.val.keyDelim,!1,!1).toLowerCase(),"action"==g)){b=a.lib.strim(b,
a.val.keyDelim,null,!1,!1);l=b.split(a.val.argWrap);3!=l.length||l[0]||l[2]||(b=l[1]);c[g]=b;r=!0;continue}g="check";if(g in c||a.lib.compare(g,b,!0))if(g="user",g in c||a.lib.compare(g,b,!0))if(g="color",g in c||a.lib.compare(g,b,!0))if(g="repeat",g in c||a.lib.compare(g,b,!0))if(g="noalign",g in c||a.lib.compare(g,b,!0))if(g="nowait",g in c||a.lib.compare(g,b,!0))if(0!=d||x||a.val.putDelim==b)if(1==d&&!v&&x&&a.val.putDelim!=b)var v=b;else break;else var x=b.toLowerCase();else c[g]=!0;else c[g]=
!0;else c[g]=!0;else c[g]=!0;else c[g]=!0;else c[g]=!0}}f||("item"in c||(c.item="%NET-HOST%"),"unit"in c||(c.unit="%TMP-KEY%"));if(!f)for(k=!1;d<q&&!k&&!f;)b=h.arguments.item(d),a.val.putDelim!=b?(g=a.lib.strim(b,null,a.val.keyDelim,!1,!1).toLowerCase())?(b=a.lib.strim(b,a.val.keyDelim,null,!1,!1),l=b.split(a.val.argWrap),3!=l.length||l[0]||l[2]||(b=l[1]),t[g]=b):f=1:k=!0,d++;if(!f)for(;d<q&&!f;)b=h.arguments.item(d),(g=a.lib.strim(b,null,a.val.keyDelim,!1,!1)||b)?(b=a.lib.strim(b,a.val.keyDelim,
null,!1,!1),l=b.split(a.val.argWrap),3!=l.length||l[0]||l[2]||(b=l[1]),b=b.split(a.val.altWrap).join(a.val.argWrap),p[g]=b):f=2,d++;if(!f&&x&&!B)try{h.stdOut.write("Введите поисковой запрос: "),c.color&&h.stdOut.write(a.fun.escape("color","yellow")),b=h.stdIn.readLine(),c.color&&h.stdOut.write(a.fun.escape("color","default")),b=a.wsh.iconv("cp866","windows-1251",b),c.search=b,w=!1}catch(A){try{h.stdOut.writeLine()}catch(F){}f=3}switch(x){case "file":f||(c.unit||!a.lib.count(p))&&c.item||(f=5);!f&&
(c.nowait&&c.service||c.repeat&&(r?c.nowait:!c.color)||a.lib.count(t)||c.user)&&(f=6);f||(q=e.getAbsolutePathName(v),e.fileExists(q)?v=e.getFile(q):f=7);if(!f){b=a.wsh.getFileText(v.path);switch(!0){case a.lib.hasValue(b,a.val.tsvDelim,!0):v=a.val.tsvDelim;break;case a.lib.hasValue(b,a.val.csvDelim,!0):v=a.val.csvDelim;break;default:v=""}var y=v?a.lib.tsv2arr(b,!0,v,!1,!0):[]}if(!f)for(q=y.length,d=0;d<q;d++)e=y[d],a.fun.checkDataProperty(e,c.search)&&e["NET-HOST"]&&m.push(e);break;case "folder":f||
(c.unit||!a.lib.count(p))&&c.item||(f=5);!f&&(c.nowait&&c.service||c.repeat&&(r?c.nowait:!c.color)||a.lib.count(t)||c.user)&&(f=6);f||(q=e.getAbsolutePathName(v),e.folderExists(q)?v=e.getFolder(q):f=7);if(!f)for(q=new Enumerator(v.files);!q.atEnd();){b=q.item();q.moveNext();b=a.wsh.getFileText(b.path);switch(!0){case a.lib.hasValue(b,a.val.keyDelim,!0):v=a.val.keyDelim;break;default:v=""}e=v?a.lib.ini2obj(b,!1):null;a.fun.checkDataProperty(e,c.search)&&e["NET-HOST"]&&m.push(e)}break;case "ldap":!f&&
(!c.unit&&a.lib.count(p)||!c.item||v&&!a.lib.validate(v,"guid"))&&(f=5);!f&&(c.nowait&&c.service||c.repeat&&(r?c.nowait:!c.color))&&(f=6);f||(v=a.wsh.getLDAP(v)[0])||(f=7);f||(y=a.wsh.getLDAP("WHERE objectClass = 'Computer'"+(c.search?" AND (name = '*"+c.search+"*' OR description = '*"+c.search+"*' OR operatingSystemVersion = '*"+c.search+"*' OR description = '*"+a.fun.translit(c.search)+"*')":""),v));if(!f)for(q=y.length,d=0;d<q;d++){l=y[d];e={};if(b=a.fun.getItemProperty(l,"cn"))e["NET-HOST"]=b;
if(b=a.fun.getItemProperty(l,"distinguishedName"))e["NET-HOST-DN"]=b;if(b=a.fun.getItemProperty(l,"operatingSystem"))e["SYS-NAME"]=b;if(b=a.fun.getItemProperty(l,"operatingSystemVersion").replace(" (",".").replace(")",""))e["SYS-VERSION"]=b;for(g in t)e=a.lib.extend(e,a.fun.getDataPattern(t[g],a.fun.getItemProperty(l,g),!1));if(c.user&&e["USR-NAME-FIRST"]&&e["USR-NAME-SECOND"]&&(k=a.wsh.getLDAP("WHERE objectClass = 'User' AND sn = '"+e["USR-NAME-FIRST"]+"' AND givenName = '"+e["USR-NAME-SECOND"]+
"'",v),k.length)){l=k[0];if(b=a.fun.getItemProperty(l,"co"))e["USR-COUNTRY"]=b;if(b=a.fun.getItemProperty(l,"c"))e["USR-COUNTRY-ID"]=b;if(b=a.fun.getItemProperty(l,"company"))e["USR-COMPANY"]=b;if(b=a.fun.getItemProperty(l,"displayName"))e["USR-NAME"]=b;if(b=a.fun.getItemProperty(l,"department"))e["USR-DEPARTMENT"]=b;if(b=a.fun.getItemProperty(l,"homeDirectory"))e["USR-HOME"]=b;if(b=a.fun.getItemProperty(l,"l"))e["USR-CITY"]=b;if(b=a.fun.getItemProperty(l,"mail"))e["USR-EMAIL"]=b;if(b=a.fun.getItemProperty(l,
"mobile"))e["USR-MOBILE"]=b;if(b=a.fun.getItemProperty(l,"objectSid"))e["USR-SID"]=b;if(b=a.fun.getItemProperty(l,"sAMAccountName"))e["USR-LOGIN"]=b;if(b=a.fun.getItemProperty(l,"distinguishedName"))e["USR-ACCOUNT-DN"]=b;if(b=a.fun.getItemProperty(l,"telephoneNumber"))e["USR-PHONE"]=b;if(b=a.fun.getItemProperty(l,"title"))e["USR-POSITION"]=b;if(b=a.fun.getItemProperty(l,"info"))e["USR-INFO"]=b}e["NET-HOST"]&&m.push(e)}break;default:!f&&x&&(f=4),f||a.lib.count(p,!0)&&c.unit||(f=5),!f&&(a.lib.count(t)||
c.repeat&&(r?c.nowait:!c.color)||B||u||c.service||c.check||c.user)&&(f=6)}f||!x||m.length||(f=8);if(m.length){if(c.check){if(!f)try{var I=E.connectServer(".","root\\CIMV2",null,null,null,null,128)}catch(A){f=9}if(!f)for(q=m.length,d=0;d<q;d++)for(e=m[d],x=I.execQuery("SELECT responseTime, statusCode FROM Win32_PingStatus WHERE address = '"+e["NET-HOST"]+"' AND timeout = 600"),x=new Enumerator(x);!x.atEnd();){l=x.item();x.moveNext();0==l.statusCode&&(e["TMP-CHECK"]=l.responseTime+" мс");break}}if(!f){var z=
{};q=m.length;for(d=0;d<q;d++)if(e=m[d],e["TMP-INDEX"]=a.lib.strPad(d+1,(""+q).length,"0","left"),!c.noalign)for(g in e)z[g]=Math.max(e[g].length,z[g]||0)}if(!f){q=m.length;w||h.stdOut.writeLine();for(d=0;d<q;d++){e=m[d];e=a.lib.clone(e);if(!c.noalign)for(g in z)e[g]=a.lib.strPad(e[g]||"",z[g]," ",isNaN(a.lib.trim(e[g]).charAt(0))?"right":"left");if(b=e["TMP-INDEX"])e["TMP-INDEX"]=a.fun.escape("color",c.color&&"yellow",b,!0);if(b=e["NET-HOST"])e["NET-HOST"]=a.fun.escape("color",c.color&&"cyan",b,
!0);b=a.fun.setDataPattern(c.item,e,!1);h.stdOut.writeLine(b)}a.lib.count(p,!0)&&h.stdOut.writeLine();w=!0}}l=null;if(a.lib.count(p,!0)){if(m.length){if(!f&&!u)try{h.stdOut.write("Введите номер объекта: "),c.color&&h.stdOut.write(a.fun.escape("color","yellow")),b=h.stdIn.readLine(),c.color&&h.stdOut.write(a.fun.escape("color","default")),b=a.wsh.iconv("cp866","windows-1251",b),b=isNaN(b)?-1:Number(b)-1,c.index=b,w=!1}catch(A){try{h.stdOut.writeLine()}catch(F){}f=10}f||(l=m[c.index])||(f=11);if(!f)for(g in e=
l,m=D.environment(a.val.envType),e)b=e[g],setEnv(m,g,b)}if(!f)for(g in y=[],z={},d=0,q=a.lib.count(p,!0),p){b=p[g];k=!b;e={};e["TMP-KEY"]=g;if(!k){e["TMP-VALUE"]=D.expandEnvironmentStrings(b);e["TMP-INDEX"]=a.lib.strPad(d+1,(""+q).length,"0","left");if(!c.noalign)for(g in e)z[g]=Math.max(e[g].length,z[g]||0);d++}y.push(e)}if(!f){q=y.length;w||h.stdOut.writeLine();for(d=0;d<q;d++){e=y[d];e=a.lib.clone(e);k=!e["TMP-INDEX"];if(!c.noalign)for(g in z)e[g]=a.lib.strPad(e[g]||"",z[g]," ",isNaN(a.lib.trim(e[g]).charAt(0))?
"right":"left");if(b=e["TMP-VALUE"])e["TMP-VALUE"]=a.fun.escape("color",c.color&&"cyan",b,!0);if(b=e["TMP-INDEX"])e["TMP-INDEX"]=a.fun.escape("color",c.color&&"yellow",b,!0);(b=e["TMP-KEY"])&&k&&(e["TMP-KEY"]=a.fun.escape("color",c.color&&"yellow",b,!0));b=a.fun.setDataPattern(k?a.fun.clearPattern(c.unit):c.unit,e,!1);h.stdOut.writeLine(b)}r||h.stdOut.writeLine();!r&&c.color&&h.stdOut.writeLine()}do{if(!f&&!r)try{for(g in d=0,c.action=null,c.color&&h.stdOut.write(a.fun.escape("cursor","up",null,!0)),
c.color&&h.stdOut.write(a.fun.escape("color","default")),h.stdOut.write("Введите номер действия: "),c.color&&h.stdOut.write(a.fun.escape("color","yellow")),b=h.stdIn.readLine(),c.color&&h.stdOut.write(a.fun.escape("color","default")),b=a.wsh.iconv("cp866","windows-1251",b),b=isNaN(b)?-1:Number(b)-1,p)p[g]&&b==d++&&(c.action=g)}catch(A){try{h.stdOut.writeLine()}catch(F){}f=12}if(!f)if(c.action in p){b=p[c.action];var G=D.expandEnvironmentStrings(b)}else f=13;f||G||(f=14);if(!f&&c.service){e=l;try{var H=
E.connectServer(e["NET-HOST"],"root\\CIMV2",null,null,null,null,128)}catch(A){f=15}}if(!f&&c.service)try{var C=H.get("Win32_Service.Name='"+c.service+"'");!C.started&&C.startService()&&(f=17)}catch(A){f=16}if(!f)try{D.run(G,1,!c.nowait)}catch(A){f=18}if(!f&&c.service)try{C=H.get("Win32_Service.Name='"+c.service+"'"),C.started&&C.stopService()&&(f=19)}catch(A){f=16}}while(!f&&c.repeat)}if(f&&(b={1:"У входящего параметра отсутствует значение.",2:"Задано пустое значение в параметре с действием.",3:"Не удалось инициировать получение поискового запроса.",
4:"Указан не поддерживаемый режим.",5:"Обязательные параметры не прошли проверку или отсутствуют.",6:"Задана не допустимая комбинация параметров.",7:"Не удалось получить контейнер для поиска данных.",8:"Не удалось найти подходящие объекты.",9:"Не удалось подключиться к локальному компьютеру.",10:"Не удалось инициировать получение номера объекта.",11:"Отсутствует объект с указанным номером.",12:"Не удалось инициировать получение номера действия.",13:"Отсутствует указанное действие.",14:"Сформирована пустая команды для действия.",
15:"Не удалось подключиться к удалённому компьютеру.",16:"Не удалось найти указанную службу на удалённому компьютеру.",17:"Не удалось запустить службу на удалённом компьютере.",18:"Не удалось выполнить комманду указанного действия.",19:"Не удалось остановить службу на удалённом компьютере."}[f])){b=a.fun.escape("color",c.color&&"red",b,!0);try{h.stdErr.write(b)}catch(A){h.echo(b)}}h.quit(f)}})})(WSH,search);search.init();
