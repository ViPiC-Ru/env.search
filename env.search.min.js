...
(function(l,b,I){b.lib.extend(b,{fun:{translit:function(e){var k="";var t={"щ":"shch","ё":"yo","ж":"zh","ч":"ch","ш":"sh","ю":"yu","я":"ya","х":"kh","а":"a","б":"b","в":"v","г":"g","д":"d","е":"e","з":"z","и":"i","й":"j","к":"k","л":"l","м":"m","н":"n","о":"o","п":"p","р":"r","с":"s","т":"t","у":"u","ф":"f","ц":"c","ы":"y","э":"e","ъ":"","ь":""};e=e||"";for(var c=0,m=e.length;c<m;c++){var r=!1;for(var q in t)if(value=e.substr(c,q.length),r=value.toLowerCase()==q)break;r?((r=value==value.toLowerCase())?
value=t[q]:(value=e.substr(c+q.length,1),value=(r=value==value.toUpperCase())?t[q].toUpperCase():t[q].substr(0,1).toUpperCase()+t[q].substr(1)),c+=q.length-1):value=e.substr(c,1);k+=value}return k},count:function(e){var k=0;if(e)for(var t in e)k++;return k},color:function(e,k,t){k=k?""+k:"";var c=String.fromCharCode(27)+"[";switch(e){case "reset":var m=0;break;case "black":m=90;break;case "red":m=91;break;case "green":m=92;break;case "yellow":m=93;break;case "blue":m=94;break;case "purple":m=95;break;
case "cyan":m=96;break;case "white":m=97}isNaN(m)?e=k:(e=c+m+"m"+k,t||(e+=c+0+"m"));return e},getItemProperty:function(e,k){var t="";try{t=e.get(k)}catch(c){}return t},getDataPattern:function(e,k,t){var c,m=0,r={},q=0;k=k?""+k:"";e=(e?""+e:"").split(b.val.envWrap);for(var f=0,A=e.length;f<A&&!q;f++){var v=e[f];if(f%2&&f!=A-1)if(c=t?v:v.toUpperCase()){v=e[f+1];var x=v.length?k.indexOf(v,m):k.length;~x?(r[c]=k.substr(m,x-m),m=x):q=3}else q=2;else x=k.indexOf(v,m),m==x?m+=v.length:q=1}return q?{}:r},
setDataPattern:function(e,k,t){k=k||{};e=(e?""+e:"").split(b.val.envWrap);for(var c=0,m=e.length;c<m;c++)if(c%2&&c!=m-1){var r=e[c];e[c]="";for(var q in k)b.lib.compare(q,r,!t)||(e[c]=k[q])}return e.join("")}},init:function(){var e,k,t,c={},m={},r={},q=!0,f=0;var A=new ActiveXObject("WScript.Shell");var v=new ActiveXObject("Scripting.FileSystemObject");var x=new ActiveXObject("wbemScripting.Swbemlocator");x.security_.impersonationLevel=3;if(!f){var p=l.arguments.length;for(e=0;e<Math.min(p,2);e++){var a=
l.arguments.item(e);switch(e){case 0:var G=a.toLowerCase();break;case 1:var u=a}}}if(!f)for(;e<p;e++){a=l.arguments.item(e);if(!("service"in c)){var g=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase();if("service"==g){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);var h=a.split(b.val.argWrap);3!=h.length||h[0]||h[2]||(a=h[1]);c[g]=a;continue}}if(!("item"in c)&&(g=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"item"==g)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);h=a.split(b.val.argWrap);
3!=h.length||h[0]||h[2]||(a=h[1]);c[g]=a;continue}if(!("unit"in c)&&(g=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"unit"==g)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);h=a.split(b.val.argWrap);3!=h.length||h[0]||h[2]||(a=h[1]);c[g]=a;continue}if(!("search"in c)&&(g=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"search"==g)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);h=a.split(b.val.argWrap);3!=h.length||h[0]||h[2]||(a=h[1]);c[g]=a;continue}if(!("index"in c)&&(g=b.lib.strim(a,
null,b.val.keyDelim,!1,!1).toLowerCase(),"index"==g)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);h=a.split(b.val.argWrap);3!=h.length||h[0]||h[2]||(a=h[1]);a=isNaN(a)?-1:Number(a)-1;c[g]=a;continue}if(!("action"in c)&&(g=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"action"==g)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);h=a.split(b.val.argWrap);3!=h.length||h[0]||h[2]||(a=h[1]);c[g]=a;continue}if("check"in c||b.lib.compare("check",a,!0))if("user"in c||b.lib.compare("user",a,!0))if("color"in
c||b.lib.compare("color",a,!0))if("noalign"in c||b.lib.compare("noalign",a,!0))if("nowait"in c||b.lib.compare("nowait",a,!0))break;else c.nowait=!0;else c.noalign=!0;else c.color=!0;else c.user=!0;else c.check=!0}"item"in c||(c.item="%NET-HOST%");"unit"in c||(c.unit="%TMP-KEY%");if(!f)for(k=!1;e<p&&!k&&!f;)a=l.arguments.item(e),b.val.putDelim!=a?(g=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase())?(a=b.lib.strim(a,b.val.keyDelim,null,!1,!1),h=a.split(b.val.argWrap),3!=h.length||h[0]||h[2]||
(a=h[1]),m[g]=a):f=1:k=!0,e++;if(!f)for(;e<p&&!f;)a=l.arguments.item(e),(g=b.lib.strim(a,null,b.val.keyDelim,!1,!1))?(a=b.lib.strim(a,b.val.keyDelim,null,!1,!1),h=a.split(b.val.argWrap),3!=h.length||h[0]||h[2]||(a=h[1]),a=a.split(b.val.altWrap).join(b.val.argWrap),r[g]=a):f=2,e++;if(!(f||"search"in c))try{l.stdOut.write("Введите поисковой запрос: "),c.color&&l.stdOut.write(b.fun.color("yellow","",!0)),a=l.stdIn.readLine(),c.color&&l.stdOut.write(b.fun.color("reset","",!0)),a=b.wsh.iconv("cp866","windows-1251",
a),c.search=a,q=!1}catch(z){try{l.stdOut.writeLine()}catch(D){}f=3}switch(G){case "folder":f||(c.unit||!b.fun.count(r))&&c.item||(f=5);!f&&(c.nowait&&(!c.nowait||c.service)||b.fun.count(m)||c.user)&&(f=6);f||(p=v.getAbsolutePathName(u),v.folderExists(p)?u=v.getFolder(p):f=7);if(!f){var w=[];for(p=new Enumerator(u.files);!p.atEnd();){a=p.item();p.moveNext();a=b.wsh.getFileText(a.path);var d=b.lib.ini2obj(a,!1);(!c.search||b.lib.hasValue(d["NET-MAC"]||"",c.search,!1)||b.lib.hasValue(d["SYS-KEY"]||"",
c.search,!1)||b.lib.hasValue(d["NET-HOST"]||"",c.search,!1)||b.lib.hasValue(d["USR-NAME"]||"",c.search,!1)||b.lib.hasValue(d["DEV-NAME"]||"",c.search,!1)||b.lib.hasValue(d["NET-IP-V4"]||"",c.search,!1)||b.lib.hasValue(d["SYS-VERSION"]||"",c.search,!1)||b.lib.hasValue(d["USR-ACCOUNT"]||"",c.search,!1)||b.lib.hasValue(d["DEV-DESCRIPTION"]||"",c.search,!1)||b.lib.hasValue(d["PCB-BIOS-SERIAL"]||"",c.search,!1)||b.lib.hasValue(d["USR-NAME"]||"",b.fun.translit(c.search),!1))&&d["NET-HOST"]&&w.push(d)}}break;
case "ldap":!f&&(!c.unit&&b.fun.count(r)||!c.item||u&&!b.lib.validate(u,"guid"))&&(f=5);f||!c.nowait||c.nowait&&!c.service||(f=6);f||(u=b.wsh.getLDAP(u)[0])||(f=7);f||(t=b.wsh.getLDAP("WHERE objectClass = 'Computer'"+(c.search?" AND (name = '*"+c.search+"*' OR description = '*"+c.search+"*' OR operatingSystemVersion = '*"+c.search+"*' OR description = '*"+b.fun.translit(c.search)+"*')":""),u));if(!f)for(w=[],p=t.length,e=0;e<p;e++){var n=t[e];d={};if(a=b.fun.getItemProperty(n,"cn"))d["NET-HOST"]=
a;if(a=b.fun.getItemProperty(n,"distinguishedName"))d["NET-HOST-DN"]=a;if(a=b.fun.getItemProperty(n,"operatingSystem"))d["SYS-NAME"]=a;if(a=b.fun.getItemProperty(n,"operatingSystemVersion").replace(" (",".").replace(")",""))d["SYS-VERSION"]=a;for(g in m)d=b.lib.extend(d,b.fun.getDataPattern(m[g],b.fun.getItemProperty(n,g),!1));if(c.user&&d["USR-NAME-FIRST"]&&d["USR-NAME-SECOND"]&&(v=b.wsh.getLDAP("WHERE objectClass = 'User' AND sn = '"+d["USR-NAME-FIRST"]+"' AND givenName = '"+d["USR-NAME-SECOND"]+
"'",u),v.length)){n=v[0];if(a=b.fun.getItemProperty(n,"co"))d["USR-COUNTRY"]=a;if(a=b.fun.getItemProperty(n,"c"))d["USR-COUNTRY-ID"]=a;if(a=b.fun.getItemProperty(n,"company"))d["USR-COMPANY"]=a;if(a=b.fun.getItemProperty(n,"displayName"))d["USR-NAME"]=a;if(a=b.fun.getItemProperty(n,"department"))d["USR-DEPARTMENT"]=a;if(a=b.fun.getItemProperty(n,"homeDirectory"))d["USR-HOME"]=a;if(a=b.fun.getItemProperty(n,"l"))d["USR-CITY"]=a;if(a=b.fun.getItemProperty(n,"mail"))d["USR-EMAIL"]=a;if(a=b.fun.getItemProperty(n,
"mobile"))d["USR-MOBILE"]=a;if(a=b.fun.getItemProperty(n,"objectSid"))d["USR-SID"]=a;if(a=b.fun.getItemProperty(n,"sAMAccountName"))d["USR-ACCOUNT"]=a;if(a=b.fun.getItemProperty(n,"telephoneNumber"))d["USR-PHONE"]=a;if(a=b.fun.getItemProperty(n,"title"))d["USR-POSITION"]=a;if(a=b.fun.getItemProperty(n,"info"))d["USR-INFO"]=a}d["NET-HOST"]&&w.push(d)}break;default:f||(f=4)}if(c.check){if(!f)try{var H=x.connectServer("","root\\CIMV2")}catch(z){f=8}if(!f)for(p=w.length,e=0;e<p;e++)for(d=w[e],u=H.execQuery("SELECT responseTime, statusCode FROM Win32_PingStatus WHERE address = '"+
d["NET-HOST"]+"' AND timeout = 600"),u=new Enumerator(u);!u.atEnd();){n=u.item();u.moveNext();0==n.statusCode&&(d["TMP-CHECK"]=n.responseTime+" мс");break}}if(!f){var y={};p=w.length;for(e=0;e<p;e++)if(d=w[e],d["TMP-INDEX"]=b.lib.strPad(e+1,(""+p).length,"0","left"),!c.noalign)for(g in d)y[g]=Math.max(d[g].length,y[g]||0)}if(!f)if(p=w.length){q||l.stdOut.writeLine();for(e=0;e<p;e++){d=w[e];d=b.lib.clone(d);if(!c.noalign)for(g in y)d[g]=b.lib.strPad(d[g]||"",y[g]," ",isNaN(b.lib.trim(d[g]).charAt(0))?
"right":"left");if(a=d["TMP-INDEX"])d["TMP-INDEX"]=b.fun.color(c.color?"yellow":null,a);if(a=d["NET-HOST"])d["NET-HOST"]=b.fun.color(c.color?"cyan":null,a);a=b.fun.setDataPattern(c.item,d,!1);l.stdOut.writeLine(a)}b.fun.count(r)&&l.stdOut.writeLine();q=!0}else f=9;if(b.fun.count(r)){if(!(f||"index"in c))try{l.stdOut.write("Введите номер компьютера: "),c.color&&l.stdOut.write(b.fun.color("yellow","",!0)),a=l.stdIn.readLine(),c.color&&l.stdOut.write(b.fun.color("reset","",!0)),a=b.wsh.iconv("cp866",
"windows-1251",a),a=isNaN(a)?-1:Number(a)-1,c.index=a,q=!1}catch(z){try{l.stdOut.writeLine()}catch(D){}f=10}f||(n=w[c.index])||(f=11);if(!f)for(g in d=n,w=A.environment(b.val.envType),d)a=d[g],setEnv(w,g,a);if(!f){var C=[];y={};e=0;p=b.fun.count(r);for(g in r){d={};d["TMP-KEY"]=g;d["TMP-VALUE"]=A.expandEnvironmentStrings(r[g]);d["TMP-INDEX"]=b.lib.strPad(e+1,(""+p).length,"0","left");if(!c.noalign)for(g in d)y[g]=Math.max(d[g].length,y[g]||0);C.push(d);e++}}if(!f){p=C.length;q||l.stdOut.writeLine();
for(e=0;e<p;e++){d=C[e];d=b.lib.clone(d);if(!c.noalign)for(g in y)d[g]=b.lib.strPad(d[g]||"",y[g]," ",isNaN(b.lib.trim(d[g]).charAt(0))?"right":"left");if(a=d["TMP-VALUE"])d["TMP-VALUE"]=b.fun.color(c.color?"cyan":null,a);if(a=d["TMP-INDEX"])d["TMP-INDEX"]=b.fun.color(c.color?"yellow":null,a);a=b.fun.setDataPattern(c.unit,d,!1);l.stdOut.writeLine(a)}"action"in c||l.stdOut.writeLine()}if(!(f||"action"in c))try{for(g in e=0,l.stdOut.write("Введите номер действия: "),c.color&&l.stdOut.write(b.fun.color("yellow",
"",!0)),a=l.stdIn.readLine(),c.color&&l.stdOut.write(b.fun.color("reset","",!0)),a=b.wsh.iconv("cp866","windows-1251",a),a=isNaN(a)?-1:Number(a)-1,r)e++==a&&(c.action=g)}catch(z){try{l.stdOut.writeLine()}catch(D){}f=12}if(!f)if(c.action in r){a=r[c.action];var E=A.expandEnvironmentStrings(a)}else f=13}if(E){if(!f&&c.service)try{var F=x.connectServer(d["NET-HOST"],"root\\CIMV2")}catch(z){f=14}if(!f&&c.service)try{var B=F.get("Win32_Service.Name='"+c.service+"'");!B.started&&B.startService()&&(f=16)}catch(z){f=
15}if(!f)try{A.run(E,1,!c.nowait)}catch(z){f=17}if(!f&&c.service)try{B=F.get("Win32_Service.Name='"+c.service+"'"),B.started&&B.stopService()&&(f=18)}catch(z){f=15}}if(f&&(a={1:"У входящего параметра отсутствует значение.",2:"У параметра с действием отсутствует значение.",3:"Не удалось инициировать получение поискового запроса.",4:"Указан не поддерживаемый режим.",5:"Обязательные параметры не прошли проверку или отсутствуют.",6:"Задана не допустимая комбинация параметров.",7:"Не удалось получить контейнер для поиска данных.",
8:"Не удалось подключиться к локальному компьютеру.",9:"Не удалось найти подходящие компьютеры.",10:"Не удалось инициировать получение номера компьютера.",11:"Отсутствует компьютер с указанным номером.",12:"Не удалось инициировать получение номера действия.",13:"Отсутствует указанное действие.",14:"Не удалось подключиться к удалённому компьютеру.",15:"Не удалось найти указанную службу на удалённому компьютеру.",16:"Не удалось запустить службу на удалённом компьютере.",17:"Не удалось выполнить комманду действия.",
18:"Не удалось остановить службу на удалённом компьютере."}[f])){a=b.fun.color(c.color?"red":null,a);try{l.stdErr.write(a)}catch(z){l.echo(a)}}l.quit(f)}})})(WSH,search);search.init();
