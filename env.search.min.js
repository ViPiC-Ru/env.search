...
(function(m,b,G){b.lib.extend(b,{fun:{translit:function(f){var n="";var q={"щ":"shch","ё":"yo","ж":"zh","ч":"ch","ш":"sh","ю":"yu","я":"ya","х":"kh","а":"a","б":"b","в":"v","г":"g","д":"d","е":"e","з":"z","и":"i","й":"j","к":"k","л":"l","м":"m","н":"n","о":"o","п":"p","р":"r","с":"s","т":"t","у":"u","ф":"f","ц":"c","ы":"y","э":"e","ъ":"","ь":""};f=f||"";for(var k=0,c=f.length;k<c;k++){var r=!1;for(var l in q)if(value=f.substr(k,l.length),r=value.toLowerCase()==l)break;r?((r=value==value.toLowerCase())?
value=q[l]:(value=f.substr(k+l.length,1),value=(r=value==value.toUpperCase())?q[l].toUpperCase():q[l].substr(0,1).toUpperCase()+q[l].substr(1)),k+=l.length-1):value=f.substr(k,1);n+=value}return n},color:function(f,n,q){n=n?""+n:"";var k=String.fromCharCode(27)+"[";switch(f){case "reset":var c=0;break;case "black":c=90;break;case "red":c=91;break;case "green":c=92;break;case "yellow":c=93;break;case "blue":c=94;break;case "purple":c=95;break;case "cyan":c=96;break;case "white":c=97}isNaN(c)?f=n:(f=
k+c+"m"+n,q||(f+=k+0+"m"));return f},getItemProperty:function(f,n){var q="";try{q=f.get(n)}catch(k){}return q},getDataPattern:function(f,n,q){var k,c=0,r={},l=0;n=n?""+n:"";f=(f?""+f:"").split(b.val.envWrap);for(var t=0,g=f.length;t<g&&!l;t++){var u=f[t];if(t%2&&t!=g-1)if(k=q?u:u.toUpperCase()){u=f[t+1];var d=u.length?n.indexOf(u,c):n.length;~d?(r[k]=n.substr(c,d-c),c=d):l=3}else l=2;else d=n.indexOf(u,c),c==d?c+=u.length:l=1}return l?{}:r},setDataPattern:function(f,n,q){n=n||{};f=(f?""+f:"").split(b.val.envWrap);
for(var k=0,c=f.length;k<c;k++)if(k%2&&k!=c-1){var r=f[k];f[k]="";for(var l in n)b.lib.compare(l,r,!q)||(f[k]=n[l])}return f.join("")}},init:function(){var f,n,q,k=[],c={},r={},l={},t=!0,g=0;var u=new ActiveXObject("WScript.Shell");var d=new ActiveXObject("Scripting.FileSystemObject");var A=new ActiveXObject("wbemScripting.Swbemlocator");A.security_.impersonationLevel=3;if(!g){var p=m.arguments.length;for(f=0;f<p;f++){var a=m.arguments.item(f);if(!("service"in c)){var h=b.lib.strim(a,null,b.val.keyDelim,
!1,!1).toLowerCase();if("service"==h){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);var e=a.split(b.val.argWrap);3!=e.length||e[0]||e[2]||(a=e[1]);c[h]=a;continue}}if(!("item"in c)&&(h=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"item"==h)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);e=a.split(b.val.argWrap);3!=e.length||e[0]||e[2]||(a=e[1]);c[h]=a;continue}if(!("unit"in c)&&(h=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"unit"==h)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);e=a.split(b.val.argWrap);
3!=e.length||e[0]||e[2]||(a=e[1]);c[h]=a;continue}if(!("search"in c)&&(h=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"search"==h)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);e=a.split(b.val.argWrap);3!=e.length||e[0]||e[2]||(a=e[1]);c[h]=a;continue}if(!("index"in c)&&(h=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"index"==h)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);e=a.split(b.val.argWrap);3!=e.length||e[0]||e[2]||(a=e[1]);a=isNaN(a)?-1:Number(a)-1;c[h]=a;continue}if(!("action"in
c)&&(h=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase(),"action"==h)){a=b.lib.strim(a,b.val.keyDelim,null,!1,!1);e=a.split(b.val.argWrap);3!=e.length||e[0]||e[2]||(a=e[1]);c[h]=a;continue}if("check"in c||b.lib.compare("check",a,!0))if("user"in c||b.lib.compare("user",a,!0))if("color"in c||b.lib.compare("color",a,!0))if("noalign"in c||b.lib.compare("noalign",a,!0))if("nowait"in c||b.lib.compare("nowait",a,!0))if(0!=f||v||b.val.putDelim==a)if(1==f&&!w&&v&&b.val.putDelim!=a)var w=a;else break;
else var v=a.toLowerCase();else c.nowait=!0;else c.noalign=!0;else c.color=!0;else c.user=!0;else c.check=!0}}"item"in c||(c.item="%NET-HOST%");"unit"in c||(c.unit="%TMP-KEY%");if(!g)for(n=!1;f<p&&!n&&!g;)a=m.arguments.item(f),b.val.putDelim!=a?(h=b.lib.strim(a,null,b.val.keyDelim,!1,!1).toLowerCase())?(a=b.lib.strim(a,b.val.keyDelim,null,!1,!1),e=a.split(b.val.argWrap),3!=e.length||e[0]||e[2]||(a=e[1]),r[h]=a):g=1:n=!0,f++;if(!g)for(;f<p&&!g;)a=m.arguments.item(f),(h=b.lib.strim(a,null,b.val.keyDelim,
!1,!1))?(a=b.lib.strim(a,b.val.keyDelim,null,!1,!1),e=a.split(b.val.argWrap),3!=e.length||e[0]||e[2]||(a=e[1]),a=a.split(b.val.altWrap).join(b.val.argWrap),l[h]=a):g=2,f++;if(!g&&v&&!("search"in c))try{m.stdOut.write("Введите поисковой запрос: "),c.color&&m.stdOut.write(b.fun.color("yellow","",!0)),a=m.stdIn.readLine(),c.color&&m.stdOut.write(b.fun.color("reset","",!0)),a=b.wsh.iconv("cp866","windows-1251",a),c.search=a,t=!1}catch(y){try{m.stdOut.writeLine()}catch(C){}g=3}switch(v){case "folder":g||
(c.unit||!b.lib.count(l))&&c.item||(g=5);!g&&(c.nowait&&(!c.nowait||c.service)||b.lib.count(r)||c.user)&&(g=6);g||(p=d.getAbsolutePathName(w),d.folderExists(p)?w=d.getFolder(p):g=7);if(!g)for(p=new Enumerator(w.files);!p.atEnd();)a=p.item(),p.moveNext(),a=b.wsh.getFileText(a.path),d=b.lib.ini2obj(a,!1),(!c.search||b.lib.hasValue(d["NET-MAC"],c.search,!1)||b.lib.hasValue(d["SYS-KEY"],c.search,!1)||b.lib.hasValue(d["NET-HOST"],c.search,!1)||b.lib.hasValue(d["USR-NAME"],c.search,!1)||b.lib.hasValue(d["DEV-NAME"],
c.search,!1)||b.lib.hasValue(d["NET-IP-V4"],c.search,!1)||b.lib.hasValue(d["SYS-VERSION"],c.search,!1)||b.lib.hasValue(d["USR-LOGIN"],c.search,!1)||b.lib.hasValue(d["DEV-DESCRIPTION"],c.search,!1)||b.lib.hasValue(d["PCB-BIOS-SERIAL"],c.search,!1)||b.lib.hasValue(d["USR-NAME"],b.fun.translit(c.search),!1))&&d["NET-HOST"]&&k.push(d);break;case "ldap":!g&&(!c.unit&&b.lib.count(l)||!c.item||w&&!b.lib.validate(w,"guid"))&&(g=5);g||!c.nowait||c.nowait&&!c.service||(g=6);g||(w=b.wsh.getLDAP(w)[0])||(g=7);
g||(q=b.wsh.getLDAP("WHERE objectClass = 'Computer'"+(c.search?" AND (name = '*"+c.search+"*' OR description = '*"+c.search+"*' OR operatingSystemVersion = '*"+c.search+"*' OR description = '*"+b.fun.translit(c.search)+"*')":""),w));if(!g)for(p=q.length,f=0;f<p;f++){e=q[f];d={};if(a=b.fun.getItemProperty(e,"cn"))d["NET-HOST"]=a;if(a=b.fun.getItemProperty(e,"distinguishedName"))d["NET-HOST-DN"]=a;if(a=b.fun.getItemProperty(e,"operatingSystem"))d["SYS-NAME"]=a;if(a=b.fun.getItemProperty(e,"operatingSystemVersion").replace(" (",
".").replace(")",""))d["SYS-VERSION"]=a;for(h in r)d=b.lib.extend(d,b.fun.getDataPattern(r[h],b.fun.getItemProperty(e,h),!1));if(c.user&&d["USR-NAME-FIRST"]&&d["USR-NAME-SECOND"]&&(e=b.wsh.getLDAP("WHERE objectClass = 'User' AND sn = '"+d["USR-NAME-FIRST"]+"' AND givenName = '"+d["USR-NAME-SECOND"]+"'",w),e.length)){e=e[0];if(a=b.fun.getItemProperty(e,"co"))d["USR-COUNTRY"]=a;if(a=b.fun.getItemProperty(e,"c"))d["USR-COUNTRY-ID"]=a;if(a=b.fun.getItemProperty(e,"company"))d["USR-COMPANY"]=a;if(a=b.fun.getItemProperty(e,
"displayName"))d["USR-NAME"]=a;if(a=b.fun.getItemProperty(e,"department"))d["USR-DEPARTMENT"]=a;if(a=b.fun.getItemProperty(e,"homeDirectory"))d["USR-HOME"]=a;if(a=b.fun.getItemProperty(e,"l"))d["USR-CITY"]=a;if(a=b.fun.getItemProperty(e,"mail"))d["USR-EMAIL"]=a;if(a=b.fun.getItemProperty(e,"mobile"))d["USR-MOBILE"]=a;if(a=b.fun.getItemProperty(e,"objectSid"))d["USR-SID"]=a;if(a=b.fun.getItemProperty(e,"sAMAccountName"))d["USR-LOGIN"]=a;if(a=b.fun.getItemProperty(e,"distinguishedName"))d["USR-ACCOUNT-DN"]=
a;if(a=b.fun.getItemProperty(e,"telephoneNumber"))d["USR-PHONE"]=a;if(a=b.fun.getItemProperty(e,"title"))d["USR-POSITION"]=a;if(a=b.fun.getItemProperty(e,"info"))d["USR-INFO"]=a}d["NET-HOST"]&&k.push(d)}break;default:!g&&v&&(g=4),g||b.lib.count(l)&&c.unit||(g=5),!g&&(b.lib.count(r)||"search"in c||"index"in c||c.service||c.check||c.user)&&(g=6)}g||!v||k.length||(g=8);if(k.length){if(c.check){if(!g)try{var F=A.connectServer("","root\\CIMV2")}catch(y){g=9}if(!g)for(p=k.length,f=0;f<p;f++)for(d=k[f],
v=F.execQuery("SELECT responseTime, statusCode FROM Win32_PingStatus WHERE address = '"+d["NET-HOST"]+"' AND timeout = 600"),v=new Enumerator(v);!v.atEnd();){e=v.item();v.moveNext();0==e.statusCode&&(d["TMP-CHECK"]=e.responseTime+" мс");break}}if(!g){var x={};p=k.length;for(f=0;f<p;f++)if(d=k[f],d["TMP-INDEX"]=b.lib.strPad(f+1,(""+p).length,"0","left"),!c.noalign)for(h in d)x[h]=Math.max(d[h].length,x[h]||0)}if(!g){p=k.length;t||m.stdOut.writeLine();for(f=0;f<p;f++){d=k[f];d=b.lib.clone(d);if(!c.noalign)for(h in x)d[h]=
b.lib.strPad(d[h]||"",x[h]," ",isNaN(b.lib.trim(d[h]).charAt(0))?"right":"left");if(a=d["TMP-INDEX"])d["TMP-INDEX"]=b.fun.color(c.color?"yellow":null,a);if(a=d["NET-HOST"])d["NET-HOST"]=b.fun.color(c.color?"cyan":null,a);a=b.fun.setDataPattern(c.item,d,!1);m.stdOut.writeLine(a)}b.lib.count(l)&&m.stdOut.writeLine();t=!0}}e=null;if(b.lib.count(l)){if(k.length){if(!(g||"index"in c))try{m.stdOut.write("Введите номер компьютера: "),c.color&&m.stdOut.write(b.fun.color("yellow","",!0)),a=m.stdIn.readLine(),
c.color&&m.stdOut.write(b.fun.color("reset","",!0)),a=b.wsh.iconv("cp866","windows-1251",a),a=isNaN(a)?-1:Number(a)-1,c.index=a,t=!1}catch(y){try{m.stdOut.writeLine()}catch(C){}g=10}g||(e=k[c.index])||(g=11);if(!g)for(h in d=e,k=u.environment(b.val.envType),d)a=d[h],setEnv(k,h,a)}if(!g){var B=[];x={};f=0;p=b.lib.count(l);for(h in l){d={};d["TMP-KEY"]=h;d["TMP-VALUE"]=u.expandEnvironmentStrings(l[h]);d["TMP-INDEX"]=b.lib.strPad(f+1,(""+p).length,"0","left");if(!c.noalign)for(h in d)x[h]=Math.max(d[h].length,
x[h]||0);B.push(d);f++}}if(!g){p=B.length;t||m.stdOut.writeLine();for(f=0;f<p;f++){d=B[f];d=b.lib.clone(d);if(!c.noalign)for(h in x)d[h]=b.lib.strPad(d[h]||"",x[h]," ",isNaN(b.lib.trim(d[h]).charAt(0))?"right":"left");if(a=d["TMP-VALUE"])d["TMP-VALUE"]=b.fun.color(c.color?"cyan":null,a);if(a=d["TMP-INDEX"])d["TMP-INDEX"]=b.fun.color(c.color?"yellow":null,a);a=b.fun.setDataPattern(c.unit,d,!1);m.stdOut.writeLine(a)}"action"in c||m.stdOut.writeLine()}if(!(g||"action"in c))try{for(h in f=0,m.stdOut.write("Введите номер действия: "),
c.color&&m.stdOut.write(b.fun.color("yellow","",!0)),a=m.stdIn.readLine(),c.color&&m.stdOut.write(b.fun.color("reset","",!0)),a=b.wsh.iconv("cp866","windows-1251",a),a=isNaN(a)?-1:Number(a)-1,l)f++==a&&(c.action=h)}catch(y){try{m.stdOut.writeLine()}catch(C){}g=12}if(!g)if(c.action in l){a=l[c.action];var D=u.expandEnvironmentStrings(a)}else g=13}if(D){if(!g&&c.service)try{var E=A.connectServer(e["NET-HOST"],"root\\CIMV2")}catch(y){g=14}if(!g&&c.service)try{var z=E.get("Win32_Service.Name='"+c.service+
"'");!z.started&&z.startService()&&(g=16)}catch(y){g=15}if(!g)try{u.run(D,1,!c.nowait)}catch(y){g=17}if(!g&&c.service)try{z=E.get("Win32_Service.Name='"+c.service+"'"),z.started&&z.stopService()&&(g=18)}catch(y){g=15}}if(g&&(a={1:"У входящего параметра отсутствует значение.",2:"У параметра с действием отсутствует значение.",3:"Не удалось инициировать получение поискового запроса.",4:"Указан не поддерживаемый режим.",5:"Обязательные параметры не прошли проверку или отсутствуют.",6:"Задана не допустимая комбинация параметров.",
7:"Не удалось получить контейнер для поиска данных.",8:"Не удалось найти подходящие компьютеры.",9:"Не удалось подключиться к локальному компьютеру.",10:"Не удалось инициировать получение номера компьютера.",11:"Отсутствует компьютер с указанным номером.",12:"Не удалось инициировать получение номера действия.",13:"Отсутствует указанное действие.",14:"Не удалось подключиться к удалённому компьютеру.",15:"Не удалось найти указанную службу на удалённому компьютеру.",16:"Не удалось запустить службу на удалённом компьютере.",
17:"Не удалось выполнить комманду действия.",18:"Не удалось остановить службу на удалённом компьютере."}[g])){a=b.fun.color(c.color?"red":null,a);try{m.stdErr.write(a)}catch(y){m.echo(a)}}m.quit(g)}})})(WSH,search);search.init();
