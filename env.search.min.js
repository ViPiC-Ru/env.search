...
["item","unit"],null,!1,m,l,B,v),!d&&m.length&&m.shift()!=v&&(d=1));!d&&a.lib.hasValue(b.location)&&(d||a.lib.setParamKeys(n,[null],null,!1,m,l,B,v),!d&&m.length&&m.shift()!=v&&(d=2));!d&&a.lib.hasValue(b.location)&&a.lib.hasValue(m,v)&&(d||a.lib.setParamKeys(z,[null],a.fun.convNoEmptyParam,!1,m,l,B,v),!d&&m.length&&m.shift()!=v&&(d=3));d||(v=null,d||a.lib.setParamKeys(A,[null],a.fun.convActionParam,!1,m,l,B,v),!d&&m.length&&m.shift()!=v&&(d=4));if(!d&&a.lib.hasValue(b.location)&&(u=!("search"in b)))try{h.stdOut.write("Введите поисковой запрос: ");
...
12:"Не удалось инициировать получение номера объекта.",13:"Отсутствует объект с указанным номером.",14:"Не удалось инициировать получение номера действия.",15:"Отсутствует указанное действие.",16:"Сформирована пустая команды для действия.",17:"Не удалось подключиться к удалённому компьютеру.",18:"Не удалось найти указанную службу на удалённому компьютеру.",19:"Не удалось запустить службу на удалённом компьютере.",20:"Не удалось выполнить комманду указанного действия.",21:"Не удалось остановить службу на удалённом компьютере."}[d])){f=
