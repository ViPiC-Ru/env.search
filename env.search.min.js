...
var search=new App({dosCharset:"cp866",winCharset:"windows-1251",hideValue:"***",hideEnd:"-HIDE",argWrap:'"',altWrap:"'",envWrap:"%","spсDelim":" ",argDelim:",",keyDelim:"=",csvDelim:";",tsvDelim:"\t",putDelim:"\\\\",envType:"Process"});
(function(h,a,t){a.lib.extend(a,{fun:{translit:function(c){var k="";var p={"щ":"shch","ё":"yo","ж":"zh","ч":"ch","ш":"sh","ю":"yu","я":"ya","х":"kh","а":"a","б":"b","в":"v","г":"g","д":"d","е":"e","з":"z","и":"i","й":"j","к":"k","л":"l","м":"m","н":"n","о":"o","п":"p","р":"r","с":"s","т":"t","у":"u","ф":"f","ц":"c","ы":"y","э":"e","ъ":"","ь":""};c=c||"";for(var u=0,r=c.length;u<r;u++){var q=!1;for(var b in p)if(value=c.substring(u,u+b.length),q=value.toLowerCase()==b)break;q?((q=value==value.toLowerCase())?
...
"95";break;case "cyan":n="96";break;case "white":n="97";break;case "default":n="0"}break;case "cursor":switch(r+="[",n="1",b=r+"2K",k){case "up":q="A";break;case "down":q="B";break;case "forward":q="C";break;case "backward":q="D"}}n&&q&&(p=r+n+q+p,u&&(p+=b));return p},getItemAttribute:function(c,k){var p="";try{p=c.get(k)}catch(u){}return p},getDataPattern:function(c,k,p){var u,r=0,q={},b=0;k=k?""+k:"";c=(c?""+c:"").split(a.val.envWrap);for(var n=0,z=0,A=c.length;n<A&&!b;n++){var e=c[n];var F=(u=
(n+z)%2&&n!=A-1)&&~e.indexOf(a.val.sp\u0441Delim);u&&!F?(F=p?e:e.toUpperCase())?(e=c[n+1],u=e.length?k.indexOf(e,r):k.length,~u?(q[F]=k.substring(r,u),r=u):b=3):b=2:(F&&(r+=a.val.envWrap.length),u=k.indexOf(e,r),r==u?r+=e.length:b=1,F&&z++)}return b?{}:q},setDataPattern:function(c,k,p,u){var r;k=k||{};c=(c?""+c:"").split(a.val.envWrap);for(var q=0,b=0,n=c.length;q<n;q++){var z=c[q];var A=(r=(q+b)%2&&q!=n-1)&&~z.indexOf(a.val.sp\u0441Delim);if(r&&!A){A=!1;for(var e in k)a.lib.compare(e,z,!p)||(z=k[e],
...
k){return k?[c,k]:[k,c]},convLocationParam:function(c){c=a.lib.url2obj(c);c.nix=a.lib.nix2win(c.path,null,!0);c.win=a.lib.nix2win(c.path,c.domain,!1);c.scheme||(c.scheme="file");return[c]},convNoEmptyParam:function(c,k){return c?[c,k]:[c,null]}},init:function(){var c,k,p,u,r=[],q=!0,b={item:"%NET-HOST%",unit:"%TMP-KEY%",location:{}};var n={};var z={};var A={},e=0;var F=new ActiveXObject("WScript.Shell");var d=new ActiveXObject("Scripting.FileSystemObject");var M=new ActiveXObject("wbemScripting.Swbemlocator");
M.security_.impersonationLevel=3;var m=a.wsh.arg2arr(h.arguments);var l=a.val.keyDelim;var B=a.val.argWrap;var v=a.val.putDelim;e||(a.lib.setParamKeys(b,null,["check","user","color","repeat"],!1,m,l,B,v),a.lib.setParamKeys(b,null,["noalign","nowait"],!1,m,l,B,v),a.lib.setParamKeys(b,"location",a.fun.convLocationParam,!1,m,l,B,v),a.lib.setParamKeys(b,["index"],a.fun.convIndexParam,!1,m,l,B,v),a.lib.setParamKeys(b,["search","action","service"],null,!1,m,l,B,v),a.lib.setParamKeys(b,["item","unit"],null,
!1,m,l,B,v),!e&&m.length&&m.shift()!=v&&(e=1));!e&&a.lib.hasValue(b.location)&&(a.lib.setParamKeys(n,[null],null,!1,m,l,B,v),!e&&m.length&&m.shift()!=v&&(e=2));!e&&a.lib.hasValue(b.location)&&a.lib.hasValue(m,v)&&(a.lib.setParamKeys(z,[null],a.fun.convNoEmptyParam,!1,m,l,B,v),!e&&m.length&&m.shift()!=v&&(e=3));e||(v=null,a.lib.setParamKeys(A,[null],a.fun.convActionParam,!1,m,l,B,v),!e&&m.length&&m.shift()!=v&&(e=4));if(!e&&a.lib.hasValue(b.location)&&(u=!("search"in b)))try{h.stdOut.write("Введите поисковой запрос: ");
b.color&&h.stdOut.write(a.fun.escape("color","yellow"));var f=h.stdIn.readLine();b.color&&h.stdOut.write(a.fun.escape("color","default"));f=a.wsh.iconv(a.val.dosCharset,a.val.winCharset,f);b.search=f;q=!1}catch(C){try{h.stdOut.writeLine()}catch(L){}e=5}e||(b.translit=b.search?a.fun.translit(b.search):"");switch(!0){case "file"==b.location.scheme&&d.fileExists(b.location.win):e||(b.unit||!a.lib.hasValue(A))&&b.item||(e=7);!e&&(b.nowait&&b.service||b.repeat&&("action"in b?b.nowait:!b.color)||b.location.user||
b.location.password||a.lib.hasValue(z)||b.user)&&(e=8);e||(p=d.getFile(b.location.win));if(!e){f=a.wsh.getFileText(p.path);switch(!1){case !a.lib.hasValue(f,a.val.tsvDelim,!0):l=a.val.tsvDelim;break;case !a.lib.hasValue(f,a.val.csvDelim,!0):l=a.val.csvDelim;break;default:l=""}var D=l?a.lib.tsv2arr(f,!0,l,!1,!0):[]}if(!e){l=0;var y=[];for(c in n){y[l]=[];v=c.split(a.val.argDelim);f=n[c];d={search:b.search,translit:b.translit};f=a.fun.setDataPattern(f,d,!1,!0);m=0;for(B=v.length;m<B;m++){var g=v[m];
var E=f;var x={name:g,wildcard:E};y[l][m]=x}l++}}if(!e){var w=0;for(n=D.length;w<n;w++){E=d=D[w];l=0;for(v=y.length;l<v&&E;l++)for(E=!1,m=0,B=y[l].length;m<B&&!E;m++)x=y[l][m],f=d[x.name],E=a.lib.match(f,x.wildcard);E&&r.push(d)}}break;case "file"==b.location.scheme&&d.folderExists(b.location.win):e||(b.unit||!a.lib.hasValue(A))&&b.item||(e=7);!e&&(b.nowait&&b.service||b.repeat&&("action"in b?b.nowait:!b.color)||b.location.user||b.location.password||a.lib.hasValue(z)||b.user)&&(e=8);e||(p=d.getFolder(b.location.win));
if(!e)for(c in l=0,y=[],n){y[l]=[];v=c.split(a.val.argDelim);f=n[c];d={search:b.search,translit:b.translit};f=a.fun.setDataPattern(f,d,!1,!0);m=0;for(B=v.length;m<B;m++)g=v[m],E=f,x={name:g,wildcard:E},y[l][m]=x;l++}if(!e)for(z=new Enumerator(p.files);!z.atEnd();){f=z.item();z.moveNext();f=a.wsh.getFileText(f.path);switch(!1){case !a.lib.hasValue(f,a.val.keyDelim,!0):l=a.val.keyDelim;break;default:l=""}E=d=l?a.lib.ini2obj(f,!1):null;l=0;for(v=y.length;l<v&&E;l++)for(E=!1,m=0,B=y[l].length;m<B&&!E;m++)x=
y[l][m],f=d[x.name],E=a.lib.match(f,x.wildcard);E&&r.push(d)}break;case "ldap"==b.location.scheme:e||(b.unit||!a.lib.hasValue(A))&&b.item||(e=7);e||(b.nowait&&b.service||b.repeat&&("action"in b?b.nowait:!b.color)||b.location.nix&&b.location.domain||b.location.user||b.location.password?e=8:b.location.nix||(b.location.nix=b.location.domain));e||(p=a.wsh.ldap(b.location.nix)[0])||(e=9);if(!e){l=0;y=[];var G={};for(c in n){y[l]=[];v=c.split(a.val.argDelim);f=n[c];d={search:b.search,translit:b.translit};
f=a.fun.setDataPattern(f,d,!1,!0);m=0;for(B=v.length;m<B;m++)g=v[m],d=a.lib.wcd2wql(f,g,function(C,L){C&&a.lib.hasValue(["manager","managedBy","member","memberOf"],L,!1)&&(C in G||(k=(x=a.wsh.ldap(C,p)[0])?a.fun.getItemAttribute(x,"distinguishedName"):null,G[C]=k),C=G[C]);return C?[C]:[]}),x={query:d},y[l][m]=x;l++}}if(!e){D=[];l=0;for(v=y.length;l<v;l++){D[l]=[];m=0;for(B=y[l].length;m<B&&!E;m++)x=y[l][m],d=x.query,D[l][m]=d;d=D[l].join(" OR ");1<B&&(d="("+d+")");D[l]=d}d=D.join(" AND ");D=a.wsh.ldap(d?
"WHERE "+d:"",p)}if(!e)for(length=D.length,w=0,n=D.length;w<n;w++){x=D[w];d={};G={cn:"NET-HOST"};for(c in G)if(g=G[c],f=a.fun.getItemAttribute(x,c))d[g]=f;for(c in z)if(d=a.lib.extend(d,a.fun.getDataPattern(z[c],a.fun.getItemAttribute(x,c),!1)),g="SYS-VERSION",f=d[g])if(f=f.replace(" (",".").replace(")",""))d[g]=f;if(b.user&&d["USR-NAME-FIRST"]&&d["USR-NAME-SECOND"]&&(y=a.wsh.ldap("WHERE objectClass = 'User' AND sn = '"+d["USR-NAME-FIRST"]+"' AND givenName = '"+d["USR-NAME-SECOND"]+"'",p),y.length))for(c in x=
y[0],G={co:"USR-COUNTRY",c:"USR-COUNTRY-ID",company:"USR-COMPANY",displayName:"USR-NAME",department:"USR-DEPARTMENT",homeDirectory:"USR-HOME",l:"USR-CITY",mail:"USR-EMAIL",mobile:"USR-MOBILE",objectSid:"USR-SID",sAMAccountName:"USR-LOGIN",distinguishedName:"USR-ACCOUNT-DN",telephoneNumber:"USR-PHONE",title:"USR-POSITION",info:"USR-INFO"},G)if(g=G[c],f=a.fun.getItemAttribute(x,c))d[g]=f;r.push(d)}break;default:!e&&b.location.scheme&&(e=6),e||a.lib.hasValue(A,!0)&&b.unit||(e=7),!e&&(a.lib.hasValue(z)||
b.repeat&&("action"in b?b.nowait:!b.color)||"search"in b||"index"in b||b.service||b.check||b.user)&&(e=8)}e||!b.location.scheme||r.length||(e=10);if(r.length){if(b.check){if(!e)try{var I=M.connectServer(".","root\\CIMV2",null,null,null,null,128)}catch(C){e=11}if(!e)for(w=0,n=r.length;w<n;w++)for(d=r[w],y=I.execQuery("SELECT responseTime, statusCode FROM Win32_PingStatus WHERE address = '"+d["NET-HOST"]+"' AND timeout = 999"),y=new Enumerator(y);!y.atEnd();){x=y.item();y.moveNext();0==x.statusCode&&
(d["TMP-CHECK"]=x.responseTime+" мс");break}}if(!e){var H={};w=0;for(n=r.length;w<n;w++){d=r[w];g="TMP-INDEX";d[g]=a.lib.strPad(w+1,(""+n).length,"0","left");d=a.lib.clone(d);for(g in d)g.substring(g.length-a.val.hideEnd.length).toUpperCase()===a.val.hideEnd&&(d[g]=a.val.hideValue);if(!b.noalign)for(g in d)H[g]=Math.max(d[g].length,H[g]||0)}}if(!e){q||h.stdOut.writeLine();w=0;for(n=r.length;w<n;w++){d=r[w];d=a.lib.clone(d);for(g in d)g.substring(g.length-a.val.hideEnd.length).toUpperCase()===a.val.hideEnd&&
(d[g]=a.val.hideValue);if(!b.noalign)for(g in H)d[g]=a.lib.strPad(d[g]||"",H[g],a.val.sp\u0441Delim,isNaN(a.lib.trim(d[g]).charAt(0))?"right":"left");g="TMP-INDEX";if(f=d[g])d[g]=a.fun.escape("color",b.color&&"yellow",f,!0);g="NET-HOST";if(f=d[g])d[g]=a.fun.escape("color",b.color&&"cyan",f,!0);f=a.fun.setDataPattern(b.item,d,!1,!0);h.stdOut.writeLine(f)}a.lib.hasValue(A,!0)&&h.stdOut.writeLine();q=!0}}x=null;if(a.lib.hasValue(A,!0)){if(r.length){if(!e&&(u=!("index"in b)))try{h.stdOut.write("Введите номер объекта: "),
b.color&&h.stdOut.write(a.fun.escape("color","yellow")),f=h.stdIn.readLine(),b.color&&h.stdOut.write(a.fun.escape("color","default")),f=a.wsh.iconv(a.val.dosCharset,a.val.winCharset,f),f=a.fun.convIndexParam(f)[0],b.index=f,q=!1}catch(C){try{h.stdOut.writeLine()}catch(L){}e=12}e||(x=r[b.index])||(e=13);if(!e)for(g in d=x,r=F.environment(a.val.envType),d)f=d[g],setEnv(r,g,f)}if(!e)for(c in D=[],H={},w=0,n=a.lib.hasValue(A,!0),A){f=A[c];I=!f;if(!I){var J=F.expandEnvironmentStrings(f);d=a.fun.getDataPattern(f,
J,!1);for(g in d)g.substring(g.length-a.val.hideEnd.length).toUpperCase()===a.val.hideEnd&&(d[g]=a.val.hideValue);J=a.fun.setDataPattern(f,d,!1,!1)}d={};g="TMP-KEY";d[g]=c;if(!I){g="TMP-VALUE";d[g]=J;g="TMP-INDEX";d[g]=a.lib.strPad(w+1,(""+n).length,"0","left");if(!b.noalign)for(g in d)H[g]=Math.max(d[g].length,H[g]||0);w++}D.push(d)}if(!e){q||h.stdOut.writeLine();w=0;for(n=D.length;w<n;w++){d=D[w];d=a.lib.clone(d);g="TMP-INDEX";f=d[g];I=!f;if(!b.noalign)for(g in H)d[g]=a.lib.strPad(d[g]||"",H[g],
a.val.sp\u0441Delim,isNaN(a.lib.trim(d[g]).charAt(0))?"right":"left");g="TMP-INDEX";if(f=d[g])d[g]=a.fun.escape("color",b.color&&"yellow",f,!0);g="TMP-VALUE";if(f=d[g])d[g]=a.fun.escape("color",b.color&&"cyan",f,!0);g="TMP-KEY";(f=d[g])&&I&&(d[g]=a.fun.escape("color",b.color&&"yellow",f,!0));f=a.fun.setDataPattern(I?a.fun.clearDelimPattern(b.unit):b.unit,d,!1,!0);h.stdOut.writeLine(f)}"action"in b||h.stdOut.writeLine();"action"in b||!b.color||h.stdOut.writeLine();q=!0}e||(u=!("action"in b));do{if(!e&&
u)try{w=0;b.action=null;b.color&&h.stdOut.write(a.fun.escape("cursor","up",null,!0));b.color&&h.stdOut.write(a.fun.escape("color","default"));h.stdOut.write("Введите номер действия: ");b.color&&h.stdOut.write(a.fun.escape("color","yellow"));f=h.stdIn.readLine();b.color&&h.stdOut.write(a.fun.escape("color","default"));f=a.wsh.iconv(a.val.dosCharset,a.val.winCharset,f);f=a.fun.convIndexParam(f)[0];for(c in A)A[c]&&f==w++&&(b.action=c);q=!1}catch(C){try{h.stdOut.writeLine()}catch(L){}e=14}e||(b.action in
A?(f=A[b.action],J=F.expandEnvironmentStrings(f)):e=15);e||J||(e=16);if(!e&&b.service){d=x;try{var N=M.connectServer(d["NET-HOST"],"root\\CIMV2",null,null,null,null,128)}catch(C){e=17}}if(!e&&b.service)try{var K=N.get("Win32_Service.Name='"+b.service+"'");!K.started&&K.startService()&&(e=19)}catch(C){e=18}if(!e)try{F.run(J,1,!b.nowait)}catch(C){e=20}if(!e&&b.service)try{K=N.get("Win32_Service.Name='"+b.service+"'"),K.started&&K.stopService()&&(e=21)}catch(C){e=18}}while(!e&&b.repeat)}if(e&&(f={1:"Указан не известный конфигурационный параметр.",
2:"Не задан ключ для фильтрующего параметра.",3:"Не задан ключ или задано пустое значение для входящего параметра.",4:"Не верно указан параметр действиея.",5:"Не удалось инициировать получение поискового запроса.",6:"Задан несуществующий или неподдерживаемый источник данных.",7:"Обязательные параметры не прошли проверку или отсутствуют.",8:"Задана не допустимая комбинация параметров.",9:"Не удалось подключиться или открыть источник данных.",10:"Не удалось найти подходящие объекты.",11:"Не удалось подключиться к локальному компьютеру.",
12:"Не удалось инициировать получение номера объекта.",13:"Отсутствует объект с указанным номером.",14:"Не удалось инициировать получение номера действия.",15:"Отсутствует указанное действие.",16:"Сформирована пустая команды для действия.",17:"Не удалось подключиться к удалённому компьютеру.",18:"Не удалось найти указанную службу на удалённому компьютеру.",19:"Не удалось запустить службу на удалённом компьютере.",20:"Не удалось выполнить комманду указанного действия.",21:"Не удалось остановить службу на удалённом компьютере."}[e])){f=
a.fun.escape("color",b.color&&"red",f,!0);try{h.stdErr.write(f)}catch(C){h.echo(f)}}h.quit(e)}})})(WSH,search);search.init();
